...
<html  lang="en-US"> 
 <head>
  ...
  <link rel="SHORTCUT ICON" type="image/x-icon" href="/ui/bb-icon2.ico">
      <link rel="stylesheet" type="text/css" media="print" href="/ui/styles/print.css?v=9.1.90132.0-2">
    <script type="text/javascript" src="/javascript/i18n.js?v=9.1.90132.0-2"></script>
...
_init_bundle_LOCALE_SETTINGS();
         ...
         <script type="text/javascript" src="/branding/__js__/22E09A32040610D97FAA38D58BD1BDC8.js?v=9.1.90132.0-2"></script>
 ...
 <frame src="/webapps/portal/execute/topframe?tab_tab_group_id=_2_1&frameSize=LARGE" name="nav" scrolling="auto" title="Blackboard Learn: Header" />
 <frame src="/webapps/blackboard/execute/content/file?cmd=view&content_id=_4179269_1&course_id=_351095_1&framesetWrapped=true" name="content" scrolling="auto" title="Content" target="_self" />
<noframes>
        ...
        <p>The <a href="/webapps/portal/execute/topframe?tab_tab_group_id=_2_1&frameSize=LARGE">Blackboard Learn: Header</a> contains a customizable institution image and navigation buttons that allow the user to access the institution home page, access Blackboard Learn help, and logout of Blackboard Learn. It also contains tabs that navigate to different areas within Blackboard Learn.</p>
        <h2>Content</h2>
        <p>The <a href="/webapps/blackboard/execute/content/file?cmd=view&content_id=_4179269_1&course_id=_351095_1&framesetWrapped=true">Content</a> always contains one of the following pages:</p>
